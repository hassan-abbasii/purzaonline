 ...
 <div class="container-fluid">
     ...
     @if(Session::has('success'))
               ...
               @endif
                        ...
                        <a href=" {{ route('allqueriesdealer')}}" class=" d-sm-inline-block btn   btn-primary shadow-sm"><i
                                class="bi bi-receipt"></i> View all Queries</a>
                    </div>
                     <!-- Content Row -->
               ...
               @forelse($record as $part)
                ...
                <tr>
                  ...
                  <td><div class="global-flex-new justify-content-center"> 
                     <a href="{{route('unblockquery',['id'=>$part->id])}}"><button class="btn btn-primary">Unblock User</button></a></div></td>
