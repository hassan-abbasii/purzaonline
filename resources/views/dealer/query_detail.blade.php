 ...
 <div class="container-fluid">
               ...
               <div class="d-sm-flex align-items-center justify-content-between  ">
                       <div class="global-flex-new1">
                        <h1 class="h3 mb-0 text-gray-800 head1"><i class="bi bi-patch-question-fill"></i> Query Detail</h1>
                         <p style="color: #adb5bd;">(Detail of Query )</p>
                       </div>
  ...
  <a href="{{route('allqueriesdealer')}}"><button class="btn btn-primary"><i class="bi bi-patch-question-fill"></i> View All </button></a>
                               </div>
                     <!-- Content Row -->
                      ...
                      <div class="div-detail">
                        <table class="table table-striped">
                          ...
                          <tr>
                            ...
                            <td>
                              @if($check==1)
                              <a href="{{route('unblockquery',['id'=>$record->id])}}"><button class="btn btn-primary">Unblock User</button></a>
                              @else
                               <a href="{{route('blockquery',['id'=>$record->id])}}"> <button class="btn btn-danger">Block User</button></a>
                               @endif
                            </td>
                          ...
                          <tr>
                            <td>
                              <a href="{{route('getrespond',['id' => $record->id])}}"><button class="btn btn-sm btn-outline-success">Respond</button></a>
                            </td>
                          </tr>
                        </table>
                      </div>
