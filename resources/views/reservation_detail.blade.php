...
@include('sidebar')
 ...
 <div class="container-fluid">
               ...
               <div class="d-sm-flex align-items-center justify-content-between  ">
                       <div class="global-flex-new1">
                        <h1 class="h3 mb-0 text-gray-800 head1"><i class="bi bi-receipt"></i> Reservation Detail</h1>
                         <p style="color: #adb5bd;">(Detail of Reservation you have made)</p>
                       </div>
  ...
  <a href="{{route('viewreserve')}}"><button class="btn btn-primary"><i class="bi bi-receipt"></i> View All </button></a>
                               </div>
                     <!-- Content Row -->
