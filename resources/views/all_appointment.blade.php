...
@include('sidebar')
 ...
 <div class="container-fluid">
              ...
              <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800 head1">Mechanic Appointments</h1>
     ...
     @if(Session::has('success'))
           ...
           <div class="review-count mb-1">
            <div class="global-flex-col">
                <p>Total Appointmnet: {{$totalCount}} </p>
                <p style="color: blue; text-align: center;"><i class="bx fa-2x bx-receipt"></i></p>
            </div>
        </div>          
...
<div class="aboutdiv-heading-border4"></div>
 <!-- Earnings (Monthly) Card Example -->
  ...
  @endif</p>
                ...
                <div class="global-flex justify-content-center"><a href="{{route('app-detail' ,['id' => $rec->id])}} "><button class="btn btn-sm btn-outline-primary">View detail</button></a><a href="{{route('cancelapp',['id' => $rec->id])}} "><button class="btn btn-sm btn-danger mx-2">Cancel</button></a><a href="{{route('delete-app',['id' => $rec->id])}}  "><button class="btn btn-sm btn-secondary"><i class="bi bi-trash"></i></button></a></div>
