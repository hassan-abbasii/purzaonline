 ...
 <div class="container-fluid">
   <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <div class="global-flex-new1">
                        <h1 class="h3 mb-0 text-gray-800 head1"><i class="bi bi-minecart"></i> Add New Car CC</h1>
                         <p style="color: #adb5bd;">(Enter Car Engine CC Detail To Add New)</p>
                       </div>
                       <div>
                        <a href="{{route('carCC')}}" class=" d-sm-inline-block btn mt-2 btn-primary shadow-sm"><i
                                class="bi bi-minecart"></i> View All Car CC</a>
</div>
...
<div class="col-md-4 mt-2 mx-2">
  ...
  <h2>Add New Car CC</h2>
  <div class="aboutdiv-heading-border4"></div>
  <form method="post" action="{{ route('add-cc')}}" id="input-form">
  ...
  <div class="form-group">
    <label>Enter Car CC </label>
    <input type="number" name="name" id="name" class="form-control w-75" required min="1" pattern="\d+(\.\d{1,2})?"> 
  </div>
   @error('name')
