 ...
 <div class="container-fluid">
   <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <div class="global-flex-new1">
                        <h1 class="h3 mb-0 text-gray-800 head1"><i class="bi bi-setting"></i> Add New Mechanic Service</h1>
                         <p style="color: #adb5bd;">(Enter Service Detail To Add New)</p>
                       </div>
                       <div>
                        <a href="{{route('mechanicservice')}}" class=" d-sm-inline-block btn mt-2 btn-primary shadow-sm"><i
                                class="bi bi-setting"></i> View All Services </a>
</div>
...
<div class="col-md-4 mt-2 mx-2">
  ...
  <div class="aboutdiv-heading-border4"></div>
  <form method="post" action="{{ route('add-mechanicservice')}}" id="input-form">
     @error('service')
...
@enderror
  ...
  <div class="form-group">
    ...
    <input type="text" name="service" id="name" class="form-control w-75"  required > 
  </div>
<div class="form-group">
    <label>Enter Service Category</label>
    <input type="text" name="category" id="name" class="form-control w-75" required  > 
  </div>
