...
@include('admin.sidebar')
 ...
 <div class="container-fluid">
               ...
               <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800 head1">Spare Parts</h1>
     ...
     @if(Session::has('success'))
               ...
               @endif
                        ...
                        <a href="{{route('addpart')}}" class=" d-sm-inline-block btn mt-2 btn-primary shadow-sm"><i
                                class="bi bi-tools"></i> Add New Spare Part</a>
                    </div>
                     <!-- Content Row -->
...
<div class="aboutdiv-heading-border4"></div>
                    <div class="row car-record justify-content-center">
                      ...
                      <h2>Spare Part General Names</h2>
    ...
    {{ $part->isDeleted ? 'Deleted' : 'false' }}
                  ...
                  <td><div class="global-flex-new justify-content-center"> 
                    <a href="{{ route('editpart', ['id' => $part->id]) }}"><button class="btn btn-secondary btn-sm"><i class="bi bi-pencil-square"></i></button></a>
                    <a href="{{ route('deletepart', ['id' => $part->id]) }}"><button class="btn btn-secondary btn-sm"><i class="bi bi-trash"></i></button></a></div></td>
