 ...
 <div class="container-fluid">
               ...
               <div class="d-sm-flex align-items-center justify-content-between  ">
                       <div class="global-flex-new1">
                        <h1 class="h3 mb-0 text-gray-800 head1"><i class="bi bi-ev-front"></i> Car Details</h1>
                         <p style="color: #adb5bd;">(The Data is General Brand Details Used in Pakistan)</p>
                       </div>
     ...
     @if(Session::has('success'))
               ...
               @endif
                        ...
                        <a href="{{route('addcar')}}" class=" d-sm-inline-block btn   btn-primary shadow-sm"><i
                                class="bi bi-car-front"></i> Add New Car </a>
                    </div>
                     <!-- Content Row -->
...
<div class="aboutdiv-heading-border4"></div>
    ...
    {{ $part->isDeleted ? 'Deleted' : 'false' }}
                  ...
                  <td><div class="global-flex-new justify-content-center"> 
                    <a href="{{ route('editcar', ['id' => $part->id]) }}"><button class="btn btn-secondary btn-sm"><i class="bi bi-pencil-square"></i></button></a>
                    <a href="{{ route('deletecar', ['id' => $part->id]) }}"><button class="btn btn-secondary btn-sm"><i class="bi bi-trash"></i></button></a></div></td>
