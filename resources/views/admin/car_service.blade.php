 ...
 <div class="container-fluid">
               ...
               <div class="d-sm-flex align-items-center justify-content-between  ">
                       <div class="global-flex-new1">
                        <h1 class="h3 mb-0 text-gray-800 head1"><i class="bi bi-wrench-adjustable"></i> Car Services</h1>
                         <p style="color: #adb5bd;">(Car Services is Detail of services used For Car Profile)</p>
                       </div>
     ...
     @if(Session::has('success'))
               ...
               @endif
                        ...
                        <a href="{{route('addcarservice')}}" class=" d-sm-inline-block btn   btn-primary shadow-sm"><i class="bi bi-wrench-adjustable"></i> Add New Car Service</a>
                    </div>
                     <!-- Content Row -->
...
<div class="aboutdiv-heading-border4"></div>
    ...
    {{ $part->isDeleted ? 'Deleted' : 'false' }}
                  ...
                  <td><div class="global-flex-new justify-content-center"> 
                    <a href="{{ route('editcarservice', ['id' => $part->id]) }}"><button class="btn btn-secondary btn-sm"><i class="bi bi-pencil-square"></i></button></a>
                    <a href="{{ route('deletecarservice', ['id' => $part->id]) }}"><button class="btn btn-secondary btn-sm"><i class="bi bi-trash"></i></button></a></div></td>
