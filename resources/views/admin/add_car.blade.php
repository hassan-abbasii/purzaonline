 ...
 <div class="container-fluid">
   <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <div class="global-flex-new1">
                        <h1 class="h3 mb-0 text-gray-800 head1"><i class="bi bi-minecart"></i> Add New Car Detail</h1>
                         <p style="color: #adb5bd;">(Enter Car Brand Detail To Add New)</p>
                       </div>
                       <div>
                        <a href="{{route('car')}}" class=" d-sm-inline-block btn mt-2 btn-primary shadow-sm"><i
                                class="bi bi-minecart"></i> View All Car </a>
</div>
...
<div class="col-md-4 mt-2 mx-2">
  ...
  <h2>Add New Car Record</h2>
  <div class="aboutdiv-heading-border4"></div>
  <form method="post" action="{{ route('add-car')}}" id="input-form">
     @error('make')
...
@enderror
  ...
  <div class="form-group">
    ...
    <input type="text" name="make" id="name" class="form-control w-75" pattern="[A-Za-z ]+" required > 
  </div>
<div class="form-group">
    <label>Enter Car Model </label>
    <input type="text" name="model" id="name" class="form-control w-75" required  > 
  </div>
  <div class="form-group">
    <label>Enter Car Variant </label>
    <input type="text" name="variant" id="name" class="form-control w-75" required  > 
  </div>
