 ...
 <div class="container-fluid">
   <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <div class="global-flex-new1">
                        <h1 class="h3 mb-0 text-gray-800 head1"><i class="bi bi-person-fill-gear"></i> Add New Mechanic </h1>
                         <p style="color: #adb5bd;">(Enter Mechanic Name to Add New)</p>
                       </div>
                       <div>
                        <a href="{{route('mechanic')}}" class=" d-sm-inline-block btn mt-2 btn-primary shadow-sm"><i
                                class="bi bi-person-fill-gear"></i> View All Mechanics </a>
</div>
...
<div class="col-md-4 mt-2 mx-2">
  ...
  <div class="aboutdiv-heading-border4"></div>
  <form method="post" action="{{ route('add-mechanic')}}" id="input-form">
     @error('name')
...
@enderror
  ...
  <div class="form-group">
    ...
    <input type="text" name="name" placeholder="Enter Mechanic Name" class="form-control w-75" id="alphabetInput" oninput="restrictInput(event)" required > 
  </div>
