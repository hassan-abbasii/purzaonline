...
<head>
 ...
 <link href="css/admin/dashboard.css" rel="stylesheet">
    ...
    <title>Add Car Service Details</title> 
</head>
<body>
 ...
 <div class="container-fluid">
   <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <div class="global-flex-new1">
                        <h1 class="h3 mb-0 text-gray-800 head1"><i class="bi bi-minecart"></i> Add New Car Service</h1>
                         <p style="color: #adb5bd;">(Enter Car Service Detail To Add New)</p>
                       </div>
                       <div>
                        <a href="{{route('carservice')}}" class=" d-sm-inline-block btn mt-2 btn-primary shadow-sm"><i
                                class="bi bi-minecart"></i> View All Car Services</a>
</div>
...
<div class="col-md-4 mt-2 mx-2">
  ...
  <h2>Add New Car Service</h2>
  <div class="aboutdiv-heading-border4"></div>
  <form method="post" action="{{ route('add-carservice')}}" id="input-form">
  ...
  <div class="form-group">
    <label>Enter Car Service Name </label>
