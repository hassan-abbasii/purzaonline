...
@include('dealer1.sidebar', ['shop' => $shop])
 ...
 <div class="container-fluid">
     ...
     @if(Session::has('success'))
           ...
           <a href="{{route('allblockedres')}}">
    <button class="btn btn-primary mt-2">Blocked Users <i class="bi bi-person"></i></button>
...
<div class="aboutdiv-heading-border4"></div>
 <!-- Earnings (Monthly) Card Example -->
  ...
  @endif</p>
                ...
                <div class="global-flex justify-content-center"><a href="{{route('detailreservationshop' ,['id' => $rec->id])}} "><button class="btn btn-sm btn-outline-primary">View detail</button></a><a href="{{route('cancelreserveshop',['id' => $rec->id])}} "><button class="btn btn-sm btn-danger mx-2">Cancel</button></a><a href="{{route('deletereserveshop',['id' => $rec->id])}}  "><button class="btn btn-sm btn-secondary"><i class="bi bi-trash"></i></button></a></div>
