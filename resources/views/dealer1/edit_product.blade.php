...
<div class="col-md-5 mt-2 mx-2">
  ...
  <div class="aboutdiv-heading-border4"></div>
  <form method="post" action="{{route('update-product',['id'=>$product1->id])}} " id="input-form" enctype="multipart/form-data">
...
@enderror
   ...
   <div class="form-group">
     ...
     <input type="text" name="name" value="{{$product1->name}}" class="form-control w-75" id="name1">
   ...
   <div class="form-group">
     ...
     <input type="number" name="quantity" value="{{$product1->quantity}}" class="form-control w-75" id="quantity">
...
<div class="form-group">
   ...
   @foreach($product as $service)
    <option value="{{ $service->id }}" @if($service->id == $product1->prod_id) selected @endif>{{ $service->name }}</option>
@endforeach
</select>
  </div> 
  <div class="form-group">
...
<div class="form-group">
     ...
     <input type="number" name="actualPrice" value="{{$product1->actualPrice}}" class="form-control w-75 " id="actualPrice">
    
   </div>
   <div class="form-group">
     <label>Enter Product Selling Price</label>
     <input type="number" name="sellingPrice" value="{{$product1->sellingPrice}}" class="form-control w-75" id="sellingPrice">
      
   </div>
   <div class="form-group">
     <label>Select Product condition</label>
     <select class="form-control w-75" value="{{$product1->condition}}" name="condition">
   ...
   <div class="form-group">
     ...
     <select class="form-control w-75" value="{{$product1->brand}}" name="brand">
