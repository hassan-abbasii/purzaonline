               ...
               <div class="d-sm-flex align-items-center justify-content-between  ">
                       <div class="global-flex-new1">
                        <h1 class="h3 mb-0 text-gray-800 head1"><i class="bi bi-patch-question-fill"></i> Queries Sent</h1>
                         <p style="color: #adb5bd;">(Detail of All Queries you have made)</p>
                       </div>
...
<div class="aboutdiv-heading-border4"></div>
            ...
            <div class="row justify-content-center">
              ...
              <div class="app-card">
                ...
                <h5 class="nameee">{{$rec->shop->name}}</h5> 
  ...
  @endif</p>
                ...
                <div class="global-flex justify-content-center"><a href="{{route('detail_query',['id' => $rec->id])}}"><button class="btn btn-sm btn-outline-primary">View detail</button></a><a href="{{route('deleteUserq',['id' => $rec->id])}}  "><button class="btn btn-sm btn-secondary"><i class="bi bi-trash"></i></button></a></div>
