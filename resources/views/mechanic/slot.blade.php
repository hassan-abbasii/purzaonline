 ...
 <div class="container-fluid">
               ...
               <div class="d-sm-flex align-items-center justify-content-between  ">
                       <div class="global-flex-new1">
                        <h1 class="h3 mb-0 text-gray-800 head1"><i class="bi bi-clock-history"></i> Slot Management</h1>
                         <p style="color: #adb5bd;">(You can manage time slots against each mechanic)</p>
                       </div>
               ...
               @foreach($record as $part)
                ...
                <tr>
                  ...
                  <td><div class="global-flex-new justify-content-center"> 
                    <a href="{{ route('timeslot', ['id' => $part->id]) }}"><button class="btn btn-primary btn-sm align-items-baseline "><i class="bi bi-"></i> View Details</button></a>
                     </div></td>
