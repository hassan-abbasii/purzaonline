 ...
 <div class="container-fluid">
               ...
               <div class="d-sm-flex align-items-center justify-content-between  ">
                       <div class="global-flex-new1">
                        <h1 class="h3 mb-0 text-gray-800 head1"><i class="bi bi-person"></i> Blocked Users</h1>
                         <p style="color: #adb5bd;">(All Blocked Users)</p>
                       </div>
     ...
     @if(Session::has('success'))
               ...
               @endif
                        ...
                        <a href=" {{ route('shopappointment')}}" class=" d-sm-inline-block btn   btn-primary shadow-sm"><i
                                class="bi bi-receipt"></i> View all Appointments</a>
                    </div>
                     <!-- Content Row -->
               ...
               @forelse($record as $part)
                ...
                <tr>
                  ...
                  <td><div class="global-flex-new justify-content-center"> 
                     <a href="{{route('unblockappointment',['id'=>$part->id])}}"><button class="btn btn-primary">Unblock User</button></a></div></td>

                </tr>
                @empty
                <tr>No Record To Show.</tr>
                  @endforelse
