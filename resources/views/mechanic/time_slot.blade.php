 ...
 <div class="container-fluid">
               ...
               <div class="d-sm-flex align-items-center justify-content-between  ">
                       <div class="global-flex-new1">
                        <h1 class="h3 mb-0 text-gray-800 head1"><i class="bi bi-clock-history"></i>Time Slot Management</h1>
                         <p style="color: #adb5bd;">(You can view Details To Manage Your Time Slots or can view Record of Time Slots)</p>
                       </div>
     ...
     @if(Session::has('success'))
               ...
               @endif
                        ...
                        <a href=" {{ route('managetimeslot', ['id' => $mec->id]) }}" class=" d-sm-inline-block btn   btn-primary shadow-sm"><i
                                class="bi bi-clock-history"></i> Manage Time Slots</a>  
                    </div>
                     <!-- Content Row -->
...
<div class="aboutdiv-heading-border4"></div>
                    <div class="row car-record justify-content-center">
                      ...
                      <h2>Time Slot Record of {{ $mec->name }}</h2>
            ...
            <table class="table table-striped thead-dark " id="myTable">
               ...
               @foreach($record as $part)
                ...
                <tr>
                  <td>{{ $part->id }}</td>
                  <td> {{$part->date}} </td>
                  <td>{{ $part->slot_time }}</td>
                  <td>{{ $part->status }}</td>
                   
                  <td><div class="global-flex-new justify-content-center"> 
                    <a href="{{ route('deleteslot', ['id' => $part->id]) }}"><button class="btn btn-primary btn-sm align-items-baseline "><i class="bi bi-"></i> Free Slot</button></a>
                     </div></td>
