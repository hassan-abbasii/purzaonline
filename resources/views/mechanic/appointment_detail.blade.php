...
@include('mechanic.sidebar', ['shop' => $shop])
 ...
 <div class="container-fluid">
  ...
  <a href="{{route('shopappointment')}}"><button class="btn btn-primary"><i class="bi bi-credit-card"></i> View All </button></a>
                               </div>
                     <!-- Content Row -->
...
@if($check==1)
                          ...
                          <tr>
                            <td colspan="2">
                             @if($check==1)
                              <a href="{{route('unblockappointment',['id'=>$record->id])}}"><button class="btn btn-primary">Unblock User</button></a>
                              @else
                               <a href="{{route('blockappointment',['id'=>$record->id])}}"> <button class="btn btn-danger">Block User</button></a>
                               @endif
                            </td>
                          </tr>
                        </table>
